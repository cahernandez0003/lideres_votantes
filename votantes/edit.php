	...
	<div class="row">
		<div class="col-md-8 offset-md-2 text-center">
			...
			<table class="table table-striped table-hover text-justify">
				...
				<tr>
					<th> Contraseña: </th>
					<td><input type="text" name="pass" class="form-control" value="<?php echo $urow['pass'] ?>" required></td>
				</tr>
				<tr>
					<th> Rol:
						<td><div class="form-group">
							<select name="rol" class="form-control">
								...
								<option value="Admin"<?php if($urow['rol']=="Admin") echo "selected";?>>Admin</option>
			...
			<?php 
				if ($_POST) {
					...
					if (modificarUsuario($con, $cedula, $nombre, $email, $telefono, $pass, $rol, $estado)) {
