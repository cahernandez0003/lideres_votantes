...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2019 a las 00:22:01
...
--
-- Base de datos: `potencialelectoral`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `actividades_lideres`
--

CREATE TABLE `actividades_lideres` (
  `actividad` bigint(20) NOT NULL,
  `usuario_id` bigint(20) NOT NULL,
  `act1` varchar(50) DEFAULT NULL,
  `soporte1` varchar(50) NOT NULL DEFAULT 'public/soport/ejemplo.docx',
...
INSERT INTO `comunicaciones` (`id`, `tipo`, `usuario_id`, `mensaje`, `fechaCreacion`) VALUES
(1, 'Recomendacion', 544, 'afasdkhasdmknfjkasddfjsiladjfklasj  asiodjfoasdj kjhf. (snlfjo)', '2019-03-09 22:18:50'),
(2, 'Recomendacion', 544, 'afasdkhasdmknfjkasddfjsiladjfklasj  asiodjfoasdj kjhf. (snlfjo)', '2019-03-09 22:18:53'),
(3, 'Queja', 544, 'candidato care chimba', '2019-03-09 22:51:18'),
(4, 'Recomendacion', 544, 'jklasdfjklasdfjklñasdfjklñasdf', '2019-03-09 22:54:35'),
(5, 'Felicitacion', 544, 'mkl sdfklñsdfasdj 53454gf56 @dsg ', '2019-03-09 22:54:51'),
(6, 'Comentario', 544, 'usted es marica', '2019-03-09 22:56:19');
...
CREATE TABLE `respuestas` (
  `id` bigint(20) NOT NULL,
  `comunicaciones_id` bigint(20) NOT NULL,
  `usuario_id` bigint(20) NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `pass` varchar(255) NOT NULL DEFAULT 'e10adc3949ba59abbe56e057f20f883e',
  `rol` varchar(22) NOT NULL DEFAULT 'Lider',
  `estado` varchar(22) NOT NULL DEFAULT 'Inactivo',
...
INSERT INTO `usuarios` (`cedula`, `nombre`, `foto`, `email`, `telefono`, `pass`, `rol`, `estado`, `fechaRegistro`) VALUES
(544, 'alasdfj', 'public/imgs/fotos/stopwatch.png', 'amasd@asdfsdf', 6554555, 'e10adc3949ba59abbe56e057f20f883e', 'Lider', 'Activo', '2019-03-13 12:25:52.213933'),
(456123, 'probando ando 2', 'public/imgs/fotos/nofoto.png	', 'probando2@gmail.com', 9874563, 'e10adc3949ba59abbe56e057f20f883e', 'Lider', 'Activo', '2019-03-13 12:25:52.213933'),
(10256535, 'luis alberto hernandez', 'public/imgs/fotos/nofoto.png	', 'megapapa@gmail.com', 8840022, '14e1b600b1fd579f47433b88e8d85291', 'Lider', 'Activo', '2019-03-13 12:25:52.213933'),
(30303030, 'alex caremonda', 'public/imgs/fotos/nofoto.png	', 'a@jajaja', 987466, 'e10adc3949ba59abbe56e057f20f883e', 'Lider', 'Activo', '2019-05-16 13:55:09.539113'),
(102304563, 'probando ando', 'public/imgs/fotos/nofoto.png	', 'probando@gmail.com', 85574166, 'e10adc3949ba59abbe56e057f20f883e', 'Lider', 'Activo', '2019-03-13 12:25:52.213933'),
(123654789, 'probando ando3', 'public/imgs/fotos/nofoto.png	', 'probando3@gmail.com', 111222333, 'e10adc3949ba59abbe56e057f20f883e', 'Lider', 'Activo', '2019-03-13 12:25:52.213933'),
(302941111, 'probando 4 ando', 'public/imgs/fotos/nofoto.png	', 'probando4@gmail.com', 5555555, 'e10adc3949ba59abbe56e057f20f883e', 'Lider', 'Activo', '2019-03-13 12:25:52.213933'),
(546546546, 'sdf,klñsdjfk', 'public/imgs/fotos/nofoto.png	', 'jejeje@jajaja', 456, 'e10adc3949ba59abbe56e057f20f883e', 'Lider', 'Inactivo', '2019-05-16 21:32:35.264025'),
(1234567890, 'Pedro Pablo Perez', 'public/imgs/fotos/bart.jpg', 'prueba@gmail.com', 8848885, 'e10adc3949ba59abbe56e057f20f883e', 'Admin', 'Activo', '2019-05-20 22:18:24.085614'),
(3148113327, 'telefono roto', 'public/imgs/fotos/nofoto.png	', 'telefono@gmail.com', 5657446, 'e10adc3949ba59abbe56e057f20f883e', 'Lider', 'Activo', '2019-03-13 12:25:52.213933');
...
CREATE TABLE `votantes` (
  ...
  `celular` bigint(25) DEFAULT NULL,
  `correo` varchar(55) DEFAULT NULL,
  `genero` varchar(15) NOT NULL,
  `departamento` varchar(20) NOT NULL,
  `municipio` varchar(20) NOT NULL,
  `zona` varchar(20) NOT NULL,
  `tipoZona` varchar(20) DEFAULT NULL,
  ...
  `rangoEdades` varchar(100) NOT NULL,
...
INSERT INTO `votantes` (`usuario_id`, `cedula`, `nombres`, `apellidos`, `direccion`, `telefono`, `celular`, `correo`, `genero`, `departamento`, `municipio`, `zona`, `tipoZona`, `barrio`, `ocupacion`, `condicionEspecial`, `discapacidad`, `tipoDiscapacidad`, `rangoEdades`, `fechaRegistro`) VALUES
(544, 1053777591, 'Carlos', 'Velasco', 'Aguirre', 8886017, 3007345895, 'carlosbass87@gmail.com', 'Masculino', '17', 'Manizales', 'Urbana', 'No', 'Aranjuez', 'empleado', 'no', 'no', 'no', '26-35', '2019-03-09 23:10:46');
...
--
-- Indices de la tabla `actividades_lideres`
--
ALTER TABLE `actividades_lideres`
...
ALTER TABLE `respuestas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `comunicaciones_id` (`comunicaciones_id`),
  ADD KEY `usuario_id` (`usuario_id`);
...
--
-- AUTO_INCREMENT de la tabla `actividades_lideres`
--
ALTER TABLE `actividades_lideres`
  MODIFY `actividad` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `actividades_lideres`
--
ALTER TABLE `actividades_lideres`
  ADD CONSTRAINT `actividades_lideres_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`cedula`);

--
-- Filtros para la tabla `comunicaciones`
--
ALTER TABLE `comunicaciones`
  ADD CONSTRAINT `comunicaciones_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`cedula`);

--
-- Filtros para la tabla `respuestas`
--
ALTER TABLE `respuestas`
  ADD CONSTRAINT `respuestas_ibfk_1` FOREIGN KEY (`comunicaciones_id`) REFERENCES `comunicaciones` (`id`),
  ADD CONSTRAINT `respuestas_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`cedula`);

--
-- Filtros para la tabla `votantes`
--
ALTER TABLE `votantes`
  ADD CONSTRAINT `votantes_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`cedula`);
COMMIT;
